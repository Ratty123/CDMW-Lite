...
- rich synthetic DDS metadata plus bounded native HKX tagfile parsing, a two-bone parent hierarchy, supported solid collision-shape output without arbitrary object-graph dots, portable helper discovery, and model-package preparation without a grid, gizmo, texture, or source mutation;
